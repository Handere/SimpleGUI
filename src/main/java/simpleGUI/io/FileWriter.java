...
public class FileWriter {
     ...
     */
    public static void writeJsonFile(String filePath, Object object, boolean append){
     ...
     * @param object The content to be written.
     */
    public static void writeCSVFile(String filepath, Object object){
     ...
     * @param append Append the content to the file if true. Overwrite if false.
     */
    public static void writeCSVFile(String filepath, Object object, boolean append){
